...
import pacman.controllers.Joy_Machado.*;
...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Hello MsPacMan");
//		exec.runGameTimed(new NearestPillPacMan(),new AggressiveGhosts(),visual);
		//exec.runGameTimed(new DFS_Controller(),new StarterGhosts(),visual);
		//exec.runGameTimed(new IterativeDeeping_Controller(),new StarterGhosts(),visual);
		...
		//exec.runGameTimed(new MiniMaxAlhpaBeta(),new StarterGhosts(),visual);
		//exec.runGameTimed(new ID3Controller(),new StarterGhosts(),visual);
		exec.runGameTimed(new AStarID3(),new StarterGhosts(),visual);
		//exec.runGameTimed(new Pacman_NeutralController(),new StarterGhosts(),visual);
